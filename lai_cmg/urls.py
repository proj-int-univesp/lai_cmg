...
urlpatterns = [
    ...
    path('ped-info/recurso-1/<int:pk>/', views.InterporRecursoPrimeiraInst.as_view(), name='recurso1_ped_info'),
    path('ped-info/recurso-2/<int:pk>/', views.InterporRecursoSegundaInst.as_view(), name='recurso2_ped_info'),
    path('ped-info/resposta/<int:pk>/', views.RespostaInicialPedInfo.as_view(), name='resposta_ped_info'),
    path('ped-info/resp-rec-1/<int:pk>/', views.RespostaRecursoPrimeiraInst.as_view(), name='resposta_rec_1'),
    path('ped-info/resp-rec-2/<int:pk>/', views.RespostaRecursoSegundaInst.as_view(), name='resposta_rec_2'),
    ...
    path('ped-infos/resp-rec-2/', views.ConsultaPedInfosRecSegInst.as_view(), name='ped_infos_resp_rec_2'),
